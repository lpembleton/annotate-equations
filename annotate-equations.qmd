...
The following is a simple step-by-step guide to annotating your first equation. Here we will use the genomic selection GEBV equation as the example.

Here's a straightforward step-by-step guide to annotating equations using the annotate-equations package. We'll illustrate with the genomic selection GEBV equation.
